...
@app.route('/')
def index():
    return render_template('租車平台網頁.html')
...
# ==============================================================================
# 2. 臨櫃登記：付款並辦理出車 (💡 需求 1 & 需求 3：狀態改為「已付清」，寫入精確秒數時間戳)
# ==============================================================================
...
def rent_process():
    ...
    try:
        ...
        # 💡 安全性修正：利用 CONCAT 避開引號解析語法錯誤，生成 "姓名 (YYYY-MM-DD HH:mm:ss)" 格式
        cursor.execute("""
...
# ==============================================================================
# 4. 臨櫃點收還車 API (💡 需求 3：還車經辦自動壓印精確秒數時間戳)
# ==============================================================================
...
# ==============================================================================
# 5. 全權限核心修改 API (💡 需求 4：支持金額/時程異動後，強制檢查補付款核銷)
# ==============================================================================
